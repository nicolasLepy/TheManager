...
namespace TheManager_GUI.VueClassement
{
    ...
    public class MatchesDataGridView
    {
        ...
        public MatchesDataGridView(StackPanel panel, List<TheManager.Match> matches, bool showDateSeparated, bool showAttendance, bool showOdds)
        {
            _panel = panel;
        ...
        public void Refresh()
        {
            ...
            Binding bind = new Binding("ShortName");
