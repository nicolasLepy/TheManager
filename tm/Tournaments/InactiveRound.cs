...
namespace tm
{
    [Obsolete("Please use GroupInactiveRound instead")]
    ...
    public class InactiveRound : Round
    {
        ...
        public InactiveRound(int id, string name, Tournament tournament, Hour hour, GameDay initialisation, GameDay end, int associationLevel) : base(id, name, tournament, hour, new List<GameDay>(), new List<TvOffset>(), initialisation, end, 1, 0, -1, 0)
        {
            _ranking = null;
        ...
        {
            Round t = new InactiveRound(Session.Instance.Game.kernel.NextIdRound(), name, Tournament, this.programmation.defaultHour, programmation.initialisation, programmation.end, _associationLevel);
