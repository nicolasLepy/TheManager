...
namespace TheManager
{
    public class TourInactif : Tour
    {
        ...
        public TourInactif(string nom, Heure heure, DateTime initialisation, DateTime fin) :base(nom,heure,new List<DateTime>(),new List<DecalagesTV>(),initialisation,fin,false)
        { }
