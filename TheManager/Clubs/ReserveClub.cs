...
namespace TheManager
{
    ...
    public class ReserveClub : Club
    {
        ...
        public ReserveClub(CityClub fannionClub, string name, string shortName, Manager manager) : base(name,manager,shortName,fannionClub.elo/2.0f,fannionClub.supporters/30,0,fannionClub.logo,fannionClub.stadium,fannionClub.goalSong, fannionClub.status)
        {
